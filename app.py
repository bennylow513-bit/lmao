    ...
    try:
        return knowledge_reply(
            ...
            (
                ...
                "Then, on the following lines, list each of that instructor's specialties or credentials as a separate indented sub-bullet starting with three spaces, a dash and a space ('   - '). "
                "If an instructor has several specialties written together, split them into separate sub-bullets where it makes sense. "
                ...
                "   - International Yoga retreat facilitator in Bali and Moscow\n"
                "\n"
                "- April\n"
                "   - Focuses on alignment and inclusive classes for all levels\n"
                "Do not change the wording of the credentials, only reformat them. "
