    ...
    try:
        return knowledge_reply(
            ...
            (
                ...
                # --- ADDING STRICT FORMATTING RULES HERE ---
                "FORMATTING RULES: "
                "1. List each instructor on a new line using this exact format: - Name — Specialization "
                "2. Do NOT use bold text, bullet points with dots, or extra headers. "
                "3. Keep the description short (one line per person). "
                # -------------------------------------------
                ...
                "If they ask a general question (like 'who are your teachers?') AND the chat history does not mention a specific class, list all the instructors found in the website content using the format above. "
